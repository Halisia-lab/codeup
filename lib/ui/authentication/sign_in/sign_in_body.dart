...
class _SignInBodyState extends State<SignInBody> {
  ...
  FocusNode _loginFocusNode = FocusNode(), _passwordFocusNode = FocusNode();
...
@override
  ...
  Widget build(BuildContext context) {
   const textFieldHeight = 80.0;
    ...
    InputBorder focusedBorderError = OutlineInputBorder(
      borderSide: BorderSide(
        width: 2,
            ...
            builder: (ctx, signInFieldsVm, softKeyboardVm, child) {
              ...
              return TextField(
                showCursor: signInFieldsVm
                    .mapSignInFieldFocus[SignInFieldEnum.email],
                ...
                decoration: InputDecoration(
                  ...
                  errorText: signInFieldsVm.getSignInFieldError(SignInFieldEnum.email)
                      .isNullOrEmpty() ? null : signInFieldsVm.getSignInFieldError(
                      SignInFieldEnum.email),
                  border: mBorder,
                  enabledBorder: signInFieldsVm.getSignInFieldError(
                      SignInFieldEnum.email).isEmptyNonNull() ? mErrorBorder : mEnabledBorder,
                  errorBorder: mErrorBorder,
                  focusedBorder: signInFieldsVm.getSignInFieldError(SignInFieldEnum.email)
          ...
          builder: (ctx, signInFieldsVm, softKeyboardVm, child) {
            ...
            return TextField(
              ...
              decoration: InputDecoration(
                ...
                border: mBorder,
                enabledBorder: signInFieldsVm.getSignInFieldError(SignInFieldEnum.password)
                    .isEmptyNonNull() ? mErrorBorder : mEnabledBorder,
                errorBorder: mErrorBorder,
                focusedBorder: signInFieldsVm.getSignInFieldError(SignInFieldEnum.password)
                    .isEmptyNonNull() ? mFocusedBorderError : mFocusedBorder,
  ...
  void _updateSignInFocusNodes(SignInFieldsViewModel signInFieldsVm) {
    ...
    } else if (signInFieldsVm.mapSignInFieldFocus[SignInFieldEnum.password] != null &&
